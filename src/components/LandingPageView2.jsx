...
import { FaInfoCircle,FaUser,FaQuoteLeft,FaStar,FaMapMarkerAlt } from 'react-icons/fa';
  ...
  return (
    ...
    >
      ...
      <ParallaxSection>
        ...
        <ParallaxSection>
        {/* About Section */}
        <Card className="shadow-[0_0_15px_5px_#000000] animate__animated animate__fadeInDownBig bg-[#1e1e1e] hover:shadow-[0_0_20px_#ff4500] transition-all duration-300 bg-opacity-80 backdrop-blur-lg text-white border-none">
  <CardHeader className="text-center">
    {/* Icon Above the Title */}
    <div className="flex justify-center mb-4">
      <FaInfoCircle className="text-[#ff4d4d] w-10 h-10" />
    </div>
    
    {/* Title */}
    <CardTitle className="text-3xl font-bold text-white mb-4 flex items-center justify-center gap-2">
      <FaUser className="text-[#ff4d4d] w-6 h-6" /> About Me
    </CardTitle>

    {/* Description */}
    <CardDescription className="text-gray-300 text-lg leading-relaxed flex flex-col gap-3">
      {/* Icon-enhanced Points */}
      <div className="flex items-start gap-3">
        <FaQuoteLeft className="text-[#ff4d4d] w-5 h-5 mt-1" />
        <span>
      ...
      <div className="flex items-start gap-3">
        ...
        <span>
          Known for: <strong>{artistPage.achievements || "Achievements here"}</strong>
        </span>
      </div>
      <div className="flex items-start gap-3">
        <FaMapMarkerAlt className="text-green-400 w-5 h-5 mt-1" />
        <span>
          Based in: <strong>{artistPage.location || "Location here"}</strong>
        </span>
      </div>
    </CardDescription>
  </CardHeader>
